...
1. Va conecatati ca SYS (conn as sysdba ) si dati comanda: GRANT EXECUTE ON UTL_FILE TO STUDENT;
2. Creati un director "D:\STUDENT" pe calculatorul vostru
3. Intrati in contul SYS (cu comanda: conn sys as sysdba) si scrieti comanda: GRANT CREATE ANY DIRECTORY TO STUDENT;  
4. Intrati in contul STUDENT executati comanda: CREATE OR REPLACE DIRECTORY MYDIR as 'D:\STUDENT';
    -- MYDIR va reprezenta un identificator pentru calea fizica unde vor fi salvate fisierele voastre
5. Intrati IAR in contul SYS si dati comanda: GRANT READ,WRITE ON DIRECTORY MYDIR TO STUDENT;
